...
class Runner():
    __customes = ("turtle", "fish", "moray", "octopus", "prawn")  
        ...
        while not gameOver:
            for event in pygame.event.get():
                if event.type == pygame.quit:  
                    ...
                    if event.key == K_UP: #Este es el codigo de pygame para la flecha de arriba, para que se mueva hacia arriba el runner
